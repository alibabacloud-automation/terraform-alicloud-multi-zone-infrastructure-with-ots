...
output "this_vpc_id" {
  ...
  value       = module.infrastructure.this_vpc_id
}

output "this_vpc_name" {
  description = "The VPC name"
  value       = module.infrastructure.this_vpc_name
}

output "this_vpc_tags" {
  description = "The tags of the VPC."
  value       = module.infrastructure.this_vpc_tags
}

output "this_vpc_cidr_block" {
  description = "The VPC cidr block."
  value       = module.infrastructure.this_vpc_cidr_block
}
...
output "this_security_group_id" {
  ...
  value       = module.infrastructure.this_security_group_id
}

output "this_security_group_vpc_id" {
  description = "The VPC ID."
  value       = module.infrastructure.this_security_group_vpc_id
}

output "this_security_group_name" {
  description = "The name of the security group."
  value       = module.infrastructure.this_security_group_name
}

output "this_security_group_description" {
  description = "The description of the security group."
  value       = module.infrastructure.this_security_group_description
}
...
output "this_nat_gateway_id" {
  ...
  value       = module.infrastructure.this_nat_gateway_id
}
output "this_dnat_table_id" {
  description = "The dnat table id in this nat gateway."
  value       = module.infrastructure.this_dnat_table_id
}
output "this_snat_table_id" {
  description = "The snat table id in this nat gateway."
  value       = module.infrastructure.this_snat_table_id
}
output "this_nat_gateway_name" {
  description = "The nat gateway name."
  value       = module.infrastructure.this_nat_gateway_name
}
output "this_nat_gateway_spec" {
  description = "The nat gateway spec."
  value       = module.infrastructure.this_nat_gateway_spec
}
output "this_nat_gateway_description" {
  description = "The nat gateway id."
  value       = module.infrastructure.this_nat_gateway_description
}
output "this_nat_gateway_status" {
  description = "The nat gateway id."
  value       = module.infrastructure.this_nat_gateway_status
}
#################
# EIP
#################
output "this_eip_ids" {
  ...
  value       = module.infrastructure.this_eip_ids
}

output "this_eip_ips" {
  description = "The id of new eip addresses."
  value       = module.infrastructure.this_eip_ips
}
...
output "this_slb_id" {
  ...
  value       = module.infrastructure.this_slb_id
}

output "this_slb_name" {
  description = "The name of new slb."
  value       = module.infrastructure.this_slb_name
}

output "this_slb_ip_address" {
  description = "The ip address of new slb."
  value       = module.infrastructure.this_slb_ip_address
}
output "this_slb_tags" {
  description = "The tags of new slb."
  value       = module.infrastructure.this_slb_tags
}
...
output "this_ots_instance_id" {
  ...
  value       = module.infrastructure.this_ots_instance_id
}

output "this_ots_instance_name" {
  description = "The name of ots instance."
  value       = module.infrastructure.this_ots_instance_name
}
